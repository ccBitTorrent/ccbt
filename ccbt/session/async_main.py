...
from ccbt.config.config import Config, get_config, init_config

# from ccbt.storage.disk_io import init_disk_io, shutdown_disk_io  # Functions don't exist yet
...
# from ccbt.utils.metrics import get_metrics_collector, init_metrics, shutdown_metrics  # Functions don't exist yet
...
class AsyncDownloadManager:
    ...
    def __init__(
        ...
        # Normalize to piece manager expected shape when given TorrentInfo
        ...
        if args.add:
            for item in args.add:
                try:
                    ...
                    logging.getLogger(__name__).exception("Failed to add %s", item)
