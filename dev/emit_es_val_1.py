"""Emit ccbt/i18n/locale_data/es_val_1.json (manual Spanish, order matches dev/es_slice_1.json)."""
...
OUT = ROOT / "ccbt/i18n/locale_data/es_val_1.json"
...
V = [
    ...
    "Opción",
    'Otros pueden unirse con: ccbt tonic sync "{link}" --output <directorio>',
...
if __name__ == "__main__":
    keys = json.loads((ROOT / "dev/es_slice_1.json").read_text(encoding="utf-8"))
    if len(V) != len(keys):
