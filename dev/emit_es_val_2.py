"""Emit ccbt/i18n/locale_data/es_val_2.json (manual Spanish, order matches dev/es_slice_2.json)."""
...
OUT = ROOT / "ccbt/i18n/locale_data/es_val_2.json"
...
if __name__ == "__main__":
    keys = json.loads((ROOT / "dev/es_slice_2.json").read_text(encoding="utf-8"))
    if len(V) != len(keys):
