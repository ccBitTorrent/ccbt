...
class TestSimpleFunctionality:
    ...
    def test_file_segment_creation(self):
        ...
        assert segment.file_path == "tests/data/test.txt"
    ...
    def test_write_request_creation(self):
        ...
        assert request.file_path == Path("tests/data/test.txt")
    ...
    def test_all_classes_instantiable(self):
        ...
        file_segment = FileSegment("tests/data/test.txt", 0, 0, 0, 1024)
        write_request = WriteRequest(Path("tests/data/test.txt"), 0, b"data", asyncio.Future())
